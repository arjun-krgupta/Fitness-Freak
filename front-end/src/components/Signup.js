...
function Signup() 
{
    ...
    const submitData = () => {
        ...
        if(password===cnfpassword)
        {
            ...
            .then((json)=>{
                setState(json)
                document.getElementById("result").innerHTML="Register Successfully"
                        ...
                        <div className="border rounded-3 my-3 bg-white">
                            ...
                            <form action="">
                                ...
                                <div className="d-grid gap-2 mx-auto col-10 my-4">
                                    <button type="button" className="btn btn-secondary w-75 mx-auto" onClick={submitData}>Register</button>
                                </div>
                            </form>
